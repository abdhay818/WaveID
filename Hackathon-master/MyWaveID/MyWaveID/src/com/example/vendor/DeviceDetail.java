...
public class DeviceDetail extends Activity{
	...
	String fileName=String.valueOf(time);
	 ...
	 private static final String SERVICE_URL = "http://192.168.1.104:5656/RestWebServiceDemo/rest/person";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button btn=(Button)findViewById(R.id.bn_register);
		...
		btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent i = new Intent(getApplicationContext(), SoundRecordingExample2.class);
				i.putExtra("RecFileName",fileName);
				startActivity(i);
...
////////////
 ...
 Contact con=null;
        ...
        wst.addNameValuePair("lastName", fileName);
