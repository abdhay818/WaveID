...
public class UserInfoValidation extends Activity {
	Button btn=null;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	 ...
	 private void registerViews() {
		 ...
		 btn=(Button) findViewById(R.id.personalInfobtn);
	 ...
	 lastName=(EditText)findViewById(R.id.editText4);
		 ...
		 addressName=(EditText)findViewById(R.id.editText2);
		 phoneName=(EditText)findViewById(R.id.editText5);
	        ...
	        btn.setOnClickListener(new View.OnClickListener() {
	            ...
	            public void onClick(View view) {
			       ...
			       // db.addContact(new Contact(_FNAME, _PHONE));
	                ...
	                {
	                    Toast.makeText(UserInfoValidation.this, "Form contains error", Toast.LENGTH_LONG).show();
	                }
