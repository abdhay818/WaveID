...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_CONTACTS + "("
				+ KEY_ID + " INTEGER PRIMARY KEY," + KEY_FIRST_NAME + " TEXT,"+ KEY_LAST_NAME + " TEXT,"+ KEY_EMAIL + " TEXT,"+ KEY_ADDRESS + " TEXT,"
				+ KEY_PH_NO + " TEXT" + ")";
	...
	void addContact(Contact contact) {
		...
		values.put(KEY_FIRST_NAME, contact.get_fname()); // Contact Name
		values.put(KEY_LAST_NAME, contact.get_lname()); // Contact Name
